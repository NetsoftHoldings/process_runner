...
require 'process_runner/redis_connection'

RSpec.describe ProcessRunner::RedisConnection do
    ...
    describe 'redis options' do
      ...
      context 'with namespace' do
        ...
        context 'when the namespace gem is not loaded' do
          ...
          it 'logs an error' do
            expect(ProcessRunner.logger).to receive(:error).and_raise(RuntimeError)
